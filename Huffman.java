...
class Huffman {
    ...
    static int[] lerArquivo() {
        ...
        texto = LerESalva.lerArquivo("a.txt");
    ...
    public static void comprimir() {
        ...
        System.out.println("\n\n"+binario);
        LerESalva.salvarArquivo("compactado.txt", binario);
    ...
    public static void descomprimir() {
        ...
        // Ler arvore
        HuffmanArvore arvore = (HuffmanArvore) IO_object.carregar("arvore.temp");
        int altura = arvore.getAltura();

        //ler String binaria
        String binaria = LerESalva.lerArquivo("compactado.txt");
        String original = "";
        ...
        LerESalva.salvarArquivo("descompactado.txt", original);
    ...
    public static class HuffmanArvore implements Serializable, Comparable<HuffmanArvore> {
        ...
        public static HuffmanArvore construirArvore(int[] ocorrencias) {
            ...
            //salvar arvore
            IO_object.salvar("arvore.temp", arvore);
            return arvore;
        }
